// Client-side script for chat and audio call functionality
...
function showConversation(recipient) {
    ...
    // Request old messages for this conversation
...
$(function () {
    ...
    socket.on('updateUserList', function(users) {
        ...
        $('#userList').append('<button class="btn btn-danger" onclick="logout()">Logout</button>');
    ...
    socket.on('message history', function(messages) {
        ...
        messages.forEach(function(msg) {
            ...
            if (msg.sender === currentRecipient) {
                $('#messages').append($('<div class="message received">').text(msg.message)
                ...
                $('#messages').append($('<div class="message sent">').text(msg.message)
                    .append(`<span class="timestamp">${time}</span>`));
                if (msg.image_url) {
                    $('#messages').append($('<div class="message sent">')
                        .html(`<img src="${msg.image_url}" class="img-fluid">`)
